...
public class EmployeeControllerTests {
    ...
    public void givenValidEmployeeId_whenGetById_thenEmployeeIsFound() throws Exception {
        ...
        BDDMockito.given(employeeService.getEmployeeById(employeeIdRequest))
                .willReturn(mockEmployeeResponse);
    ...
    public void givenInvalidEmployeeId_whenGetById_thenEmployeeIsNotFound() throws Exception {
        ...
        employeeIdRequest = -1L;
        BDDMockito.given(employeeService.getEmployeeById(employeeIdRequest))
                .willThrow(new ResourceNotFoundException("Employee not exists with given id"));
    ...
    public void givenNoThing_whenGetAll_thenEmployeeListIsFound() throws Exception {
        ...
        // given - precondition or setup
        BDDMockito.given(employeeService.getAllEmployees()).willReturn(mockEmployeesResponse);
    ...
    public void givenValidEmployee_whenUpdate_thenEmployeeIsUpdated() throws Exception {
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.firstName",
                        CoreMatchers.is(mockEmployeeUpdateResponse.getFirstName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastName",
                        CoreMatchers.is(mockEmployeeUpdateResponse.getLastName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email",
                        CoreMatchers.is(mockEmployeeUpdateResponse.getEmail())));
    }
    ...
    public void givenInvalidEmployee_whenUpdate_thenEmployeeIsNotUpdated() throws Exception {
        ...
        // given - precondition or setup
        BDDMockito.given(employeeService.updateEmployee(ArgumentMatchers.anyLong(), ArgumentMatchers.any(Employee.class)))
                .willThrow(new ResourceNotFoundException("Employee not exists with given one"));
