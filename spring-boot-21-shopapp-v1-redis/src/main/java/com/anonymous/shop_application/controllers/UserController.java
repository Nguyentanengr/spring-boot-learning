...
public class UserController {
    ...
    public ApiResponse<UserResponse> getUserById(@PathVariable("id") Long id) throws JsonProcessingException {
    ...
    private ApiResponse<Void> generateFakeUsers() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            UserRequest userRequest = UserRequest.builder()
                    ...
                    .roles(new HashSet<>(List.of(faker.number().numberBetween(1L, 2L))))
                    .build();
